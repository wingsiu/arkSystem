...
//      else
     ...
     for (var key in obj)
      {
        if ((key!=="parent") && (key!=="children") && (key !=="content") &&(typeof obj !== 'function')&& (key!=="top"))
...
//by alpha
 ...
 //                   if (context.page.parent!==-1) {
                        console.log("context.page.parent,ch:",context.page.parent.children);
                    let menu = 
                    context.page.parent.children.map(children => {
                     /*       let temp ={};
                        for (var key in children)
                        {
                            if ((key!=="parent") && (key!=="content") && (key!=="children") &&(Object.prototype.hasOwnProperty.call(children, key)))
                                temp[key] = Object.assign({},children[key]);
                          }
                        return temp;*/
                     //   return clone(children);
                    return {"item": children.item, "name":children.item.name, "path":children.url}
//                        return children;                  
                    });
                ...
                /*    } else{
                        let menu = 
                        context.page.root.children.map(children => {
                        return clone(children);
                        });
                    } */
    ...
    //                  return clone(children);
                   return {"id": children.item.id, "name":children.item.name, "path":children.url}
//                        return children;                  
                    });
 //                 console.log("content:",context.page);
         ...
         /*               let temp ={};
                        ...
                        {
                            if ((key!="parent") && (key!="children") &&(Object.prototype.hasOwnProperty.call(content, key)))
